...
class ISarjEdilebilir{
    public:
        virtual void hizliSarj() = 0;
};

class ElectricalVehicle : public ISarjEdilebilir{
    private:
    string brand;
    ...
    void hizliSarj() override {
        cout << "hey there ! im an interface func" << endl;
        charge(20);
    }
